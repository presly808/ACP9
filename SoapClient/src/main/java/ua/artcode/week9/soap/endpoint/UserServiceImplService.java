 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://endpoint.soap.week9.artcode.ua/", wsdlLocation = "http://192.168.1.55:9999/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://endpoint.soap.week9.artcode.ua/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.55:9999/UserService?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://endpoint.soap.week9.artcode.ua/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.soap.week9.artcode.ua/", "UserServiceImplPort"), UserService.class, features);
    }
